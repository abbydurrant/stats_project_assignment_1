...
```{r}
ggplot(df_epa_region, aes(x = Emissions.2018)) + geom_histogram() + facet_wrap(~ Region) + scale_x_continuous(limits = c(0,1000000.0
...
```{r}
ggplot(df_epa_region, aes(x = Cumulative_Emissions)) + geom_histogram(bins = 50, color = "white") + facet_wrap(~ Region) + labs(x = "Total Emissions", y = "Number of Facilities Within an Emissions range") + scale_x_continuous(limits = c(0,10000000.0
))
```
